...
const About = (props: Props) => {
  return (
    <div className=' w-full min-h-screen base-background bg-gradient-to-br pt-20 pb-20'>
      <div className=' layout flex flex-col gap-y-20 md:flex-row-reverse md:gap-16'>
        ...
        <div className='flex flex-col gap-12 text-center md:w-[60%] md:text-left md:gap-16 justify-center items-start'>
          ...
          <div className=' flex flex-col gap-6 justify-center items-center md:flex-row mx-auto'>
